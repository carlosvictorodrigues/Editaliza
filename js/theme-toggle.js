...
class EditalizeThemeManager {
     ...
     */
    ensureToggleButton() {
        // First, hide any legacy floating toggle
        ...
        if (!navToggle) {
            ...
            if (navContainer) {
                ...
                // Fallback: create and add to body (will be styled as floating but hidden by CSS)
                const fallbackToggle = this.createToggleButton();
