...
// Backup salvo em: temp-backup-routes.js
    ...
    async (req, res) => {
        ...
        try {
            ...
            disciplineQueues.forEach(queue => {
                ...
                console.log(`  - ${queue.name}: prioridade ${queue.weight} (${percentage}% das sessões)`);
            });
            ...
            while (totalDistributed < topicsToSchedule.length && iteration < maxIterations) {
                ...
                // Recarregar créditos quando todos ficam sem créditos
...
*/
// FIM DO BLOCO DE ROTAS LEGACY COMENTADO - USANDO SISTEMA MODULAR
