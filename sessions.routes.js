...
router.patch('/:sessionId',
    ...
    // Extra validator: allow optional session_date for rescheduling
    body('session_date').optional({ nullable: true }).isISO8601().withMessage('Data da sessao deve estar no formato YYYY-MM-DD'),
